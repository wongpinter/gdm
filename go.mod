...
replace (
	crawshaw.io/iox => github.com/crawshaw/iox v0.0.0-20181124134642-c51c3df30797
	crawshaw.io/sqlite => github.com/crawshaw/sqlite v0.3.2
	go.etcd.io/bbolt => github.com/etcd-io/bbolt v1.3.6
	...
	google.golang.org/protobuf => github.com/protocolbuffers/protobuf-go v1.36.0
	gopkg.in/check.v1 => github.com/go-check/check v0.0.0-20190902080502-41f04d3bba15
	gopkg.in/errgo.v2 => ./third_party/errgo.v2
	...
	lukechampine.com/blake3 => github.com/lukechampine/blake3 v1.1.6
	zombiezen.com/go/sqlite => github.com/zombiezen/go-sqlite v0.13.1
)

replace golang.org/x/lint => ./third_party/x-lint

replace honnef.co/go/tools => ./third_party/honnef-tools

replace cloud.google.com/go => ./third_party/cloud-google-go

replace go.opencensus.io => ./third_party/opencensus

replace gopkg.in/alecthomas/kingpin.v2 => ./third_party/kingpin
